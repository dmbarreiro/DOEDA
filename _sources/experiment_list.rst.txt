...
.. glossary::
  ...
  Aspergillus niger medium type:
    ...
    *Keywords*: :term:`Plackett-Burman`, :term:`Saturated`, :term:`Screening`
  ...
  Biological process characterization:
    ...
    *Keywords*: :term:`Center Runs`, :term:`DSD`, :term:`Foldover`
  ...
  Ceramic strength:
    ...
    *Keywords*: :term:`Center Runs`, :term:`Screening`, :term:`Fractional Factorial`

  Laser Etching:
    Average rank for the quality of ecthing on a small plastic plate, using a laser.

    *Keywords*: :term:`Blocking`, :term:`DSD`, :term:`Foldover`, :term:`Screening`
