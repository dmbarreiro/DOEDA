...
Work In Progress: 
    File path and levels encoding are hardcoded, they should
be input parameters (inline in case of filepath and through a file
in case of levels)
Levels file format (for instance):
    [
        {'index': 1,
         'map': {-1: 0, 0: 200, 1: 400}},
        {'index': 2,
...
if __name__ == "__main__":
    # TODO adapt these hardcoded path and encodings
    filepath = "csv/polyethylene_film.csv"
    levels_recoding = [
        {"index": 1, "map": {-1: 0, 0: 200, 1: 400}},
        {"index": 2, "map": {-1: 0, 0: 500, 1: 1000}},
        {"index": 3, "map": {-1: 0, 0: 500, 1: 1000}},
        {"index": 4, "map": {-1: 0, 0: 1000, 1: 2000}},
        {"index": 5, "map": {-1: 0, 0: 400, 1: 800}},
    ]
    try:
